...
raw_data = [
    ...
    # 器材三: 漫步機
    {"器材": "漫步機", "年齡": 60, "組數": 2, "次數": "不適用", "組時間": "450 (AI推估)", "休息時間": "60 (參考ACSM)"},
    {"器材": "漫步機", "年齡": 70, "組數": 2, "次數": "不適用", "組時間": "390 (AI推估)", "休息時間": "70 (參考ACSM)"},
    {"器材": "漫步機", "年齡": 80, "組數": 2, "次數": "不適用", "組時間": "330 (AI推估)", "休息時間": "80 (參考ACSM)"},
    {"器材": "漫步機", "年齡": 90, "組數": 2, "次數": "不適用", "組時間": "300 (AI推估)", "休息時間": "90 (參考ACSM)"},
    ...
    # 器材五: 復健助行車
    {"器材": "復健助行車", "年齡": 60, "組數": 2, "次數": "不適用", "組時間": "300 (AI推估)", "休息時間": "60 (參考ACSM)"},
    {"器材": "復健助行車", "年齡": 70, "組數": 4, "次數": "不適用", "組時間": "300 (AI推估)", "休息時間": "70 (參考ACSM)"},
    {"器材": "復健助行車", "年齡": 80, "組數": 6, "次數": "不適用", "組時間": "300 (AI推估)", "休息時間": "80 (參考ACSM)"},
    {"器材": "復健助行車", "年齡": 90, "組數": 8, "次數": "不適用", "組時間": "300 (AI推估)", "休息時間": "90 (參考ACSM)"},
]
...
for item in raw_data:
    sets = int(item["組數"])
    # 從帶有文字的字串中擷取純數字供後端計算使用
    set_time = int(str(item["組時間"]).split()[0])
    rest_time = int(str(item["休息時間"]).split()[0])
...
# ==========================================
# 5.5 顯示原始復健運動處方大表 (編號 1-20，帶文字說明)
# ==========================================
with st.expander("📋 點此檢視：復健運動處方大表", expanded=False):
    ...
    df_raw = df_raw.rename(columns={"器材": "器材名稱", "年齡": "年齡層", "組數": "組數", "次數": "次數", "組時間": "組時間", "休息時間": "休息時間"})
